...
class DatabaseReferenceParser:
    def __init__(self, reference_file=None):
        if reference_file is None:
            # Use absolute path to the database reference file
            project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
            reference_file = os.path.join(project_root, 'docs', 'features', 'database_reference.md')
    ...
    def _load_transportation_keywords(self):
        ...
        return {
            ...
            'stoppage': ['util_report', 'vehicle_master', 'hosp_master'],
            'stoppage_report': ['util_report', 'vehicle_master', 'hosp_master'],
            'vehicle_stop': ['util_report', 'vehicle_master', 'hosp_master'], 
            'vehicle_stoppage': ['util_report', 'vehicle_master', 'hosp_master'],
            'overspeeding': ['util_report', 'vehicle_master', 'hosp_master'],
            'overspeeding_report': ['util_report', 'vehicle_master', 'hosp_master'],
            'speed_violation': ['util_report', 'vehicle_master', 'hosp_master'],
            'distance_report': ['distance_report', 'vehicle_master', 'hosp_master'],
            'travel_report': ['distance_report', 'vehicle_master', 'hosp_master'],
            'journey_report': ['distance_report', 'vehicle_master', 'hosp_master'],
            'vehicle_distance': ['distance_report', 'vehicle_master', 'hosp_master'],
            'drum_rotation': ['distance_report', 'vehicle_master', 'hosp_master'],
            'inter_plant_travel': ['distance_report', 'vehicle_master', 'hosp_master'],
            'plant_to_plant': ['distance_report', 'vehicle_master', 'hosp_master'],
            'vehicle_travel': ['distance_report', 'vehicle_master', 'hosp_master'],
            'trip_report': ['util_report', 'trip_report', 'cur_trip_report', 'vehicle_master'],
            'vehicle_tracking': ['util_report', 'vehicle_master', 'hosp_master'],
            'vehicle_report': ['util_report', 'vehicle_master', 'hosp_master'],
            'tracking_report': ['util_report', 'vehicle_master', 'hosp_master'],
            
            # Location & Time related to vehicle tracking
            'vehicle_location': ['util_report', 'vehicle_master', 'hosp_master'],
            'stop_duration': ['util_report', 'vehicle_master'],
            'stop_time': ['util_report', 'vehicle_master'],
            'vehicle_timing': ['util_report', 'vehicle_master'],
            ...
            'travel_distance': ['distance_report'],
            'journey_distance': ['distance_report'],
            'kilometer': ['distance_report'],
            'kilometres': ['distance_report'],
            'km': ['distance_report'],
            'meter': ['distance_report'],
            'metres': ['distance_report'],
            'drum_rotation': ['distance_report'],
            'inter_plant': ['distance_report', 'hosp_master'],
            'plant_to_plant': ['distance_report', 'hosp_master'],
